...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-xfce-theme-orchis"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-xfce-theme-orchis/iso-profile
"
echo
